...
const requirements: EnvironmentRequirement[] = [
  ...
  { name: "ALLOWED_CHANNEL_ID", requiredFor: "messaging", required: false },
  { name: "LINKUP_API_KEY", requiredFor: "research", required: true },
  { name: "CALCOM_API_KEY", requiredFor: "booking", required: false },
  { name: "CALCOM_EVENT_TYPE_ID", requiredFor: "booking", required: false },
  { name: "CALCOM_TIME_ZONE", requiredFor: "booking", required: false },
  { name: "CALCOM_ATTENDEE_NAME", requiredFor: "booking", required: false },
  { name: "CALCOM_ATTENDEE_EMAIL", requiredFor: "booking", required: false },
  ...
  { name: "CLOUDFLARE_API_TOKEN", requiredFor: "publish", required: false },
  { name: "CLOUDFLARE_ACCOUNT_ID", requiredFor: "publish", required: false },
  { name: "CLOUDFLARE_KV_NAMESPACE_ID", requiredFor: "publish", required: false },
  { name: "CLOUDFLARE_PUBLISH_KEY", requiredFor: "publish", required: false },
  { name: "CLOUDFLARE_PUBLISH_LIVE_URL", requiredFor: "publish", required: false },
];
